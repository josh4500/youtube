...
class AndroidCameraView extends StatefulWidget {
  ...
  @override
  State<AndroidCameraView> createState() => _AndroidCameraViewState();
}
...
class _AndroidCameraViewState extends State<AndroidCameraView>
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((XFile? file) {
      if (mounted) {
        ...
        if (file != null) {
          // TODO(josh4500): 'Picture saved to ${file.path}'
        }
      }
    });
  }
    ...
    try {
      if (controller != null) {
        ...
        if (cameraController.value.isCaptureOrientationLocked) {
          ...
          // TODO(josh4500): 'Capture orientation unlocked'
        } else {
  ...
  void onSetFlashModeButtonPressed(FlashMode mode) {
    setFlashMode(mode).then((_) {
      ...
      // TODO(josh4500): 'Flash mode set to ${mode.toString().split('.').last}'
    });
  }
  ...
  void onSetExposureModeButtonPressed(ExposureMode mode) {
    setExposureMode(mode).then((_) {
      ...
      // TODO(josh4500): 'Exposure mode set to ${mode.toString().split('.').last}')
    });
  }
  ...
  void onSetFocusModeButtonPressed(FocusMode mode) {
    setFocusMode(mode).then((_) {
      ...
      // TODO(josh4500): 'Focus mode set to ${mode.toString().split('.').last}')
    });
  }
  ...
  void onStopButtonPressed() {
    stopVideoRecording().then((XFile? file) {
      ...
      if (file != null) {
        // TODO(josh4500): 'Video recorded to ${file.path}'
        videoFile = file;
      }
    });
  }
  ...
  Future<void> onPausePreviewButtonPressed() async {
    ...
    if (cameraController == null || !cameraController.value.isInitialized) {
      // TODO(josh4500): 'Error: select a camera first.'
      return;
    }
  ...
  void onPauseButtonPressed() {
    pauseVideoRecording().then((_) {
      ...
      // TODO(josh4500): 'Video recording paused'
    });
  }
  ...
  void onResumeButtonPressed() {
    resumeVideoRecording().then((_) {
      ...
      // TODO(josh4500): 'Video recording resumed'
    });
  }
  ...
  Future<void> startVideoRecording() async {
    ...
    if (cameraController == null || !cameraController.value.isInitialized) {
      // TODO(josh4500): Select  camera first
      return;
    }
  ...
  Future<XFile?> takePicture() async {
    final CameraController? cameraController = controller;
    if (cameraController == null || !cameraController.value.isInitialized) {
      // TODO(josh4500): set camera first
      return null;
    }
