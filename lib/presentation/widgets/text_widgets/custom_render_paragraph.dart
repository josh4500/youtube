...
class CustomRenderParagraph extends RenderBox
    with
...
class _SelectableFragment
  ...
  final CustomRenderParagraph paragraph;
      ...
      case SelectionEventType.endEdgeUpdate:
        ...
        switch (granularity) {
          ...
          case TextGranularity.word:
            result = _updateSelectionEdgeByWord(
              edgeUpdate.globalPosition,
              isEnd: edgeUpdate.type == SelectionEventType.endEdgeUpdate,
            );
    ...
    if (wordBoundary != null) {
      ...
      if (_selectableContainsOriginWord &&
        ...
        if (shouldSwapEdges) {
          ...
          assert(
            localWordBoundary.wordStart.offset >= range.start &&
